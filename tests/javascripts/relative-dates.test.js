...
test('It can handle a page with no datetimes in', async () => {
  expect.assertions(1)
  let error = false
...
describe('If there are datetimes in the page', () => {
  ...
  test('If there is no prefix, it still converts the datetime', async () => {
    expect.assertions(1)
  ...
  test('If there is a prefix, it removes it before converting the datetime', async () => {
    expect.assertions(2)
