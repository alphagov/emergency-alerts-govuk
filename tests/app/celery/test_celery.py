...
def test_success_should_log_and_call_statsd(mocker, govuk_alerts, async_task):
    statsd = mocker.patch.object(govuk_alerts.statsd_client, 'timing')
    logger = mocker.patch.object(govuk_alerts.logger, 'info')
...
def test_success_queue_when_applied_synchronously(mocker, govuk_alerts, celery_task):
    statsd = mocker.patch.object(govuk_alerts.statsd_client, 'timing')
    logger = mocker.patch.object(govuk_alerts.logger, 'info')
...
def test_failure_should_log_and_call_statsd(mocker, govuk_alerts, async_task):
    statsd = mocker.patch.object(govuk_alerts.statsd_client, 'incr')
    logger = mocker.patch.object(govuk_alerts.logger, 'exception')
...
def test_failure_queue_when_applied_synchronously(mocker, govuk_alerts, celery_task):
    statsd = mocker.patch.object(govuk_alerts.statsd_client, 'incr')
    logger = mocker.patch.object(govuk_alerts.logger, 'exception')
