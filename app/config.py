...
class Config():
    ...
    GOVUK_ALERTS_BLUE_S3_BUCKET_NAME = os.getenv("GOVUK_ALERTS_BLUE_S3_BUCKET_NAME")
    GOVUK_ALERTS_GREEN_S3_BUCKET_NAME = os.getenv("GOVUK_ALERTS_GREEN_S3_BUCKET_NAME")
    GOVUK_ALERTS_ARCHIVE_S3_BUCKET_NAME = os.getenv("GOVUK_ALERTS_ARCHIVE_S3_BUCKET_NAME")
    GOVUK_ALERTS_CURRENT_BUCKET_PARAM = os.getenv("GOVUK_ALERTS_CURRENT_BUCKET_PARAM")
