...
class Config():
    ...
    GOVUK_ALERTS_CLOUDFRONT_ID = os.getenv("GOVUK_ALERTS_CLOUDFRONT_ID")
    GOVUK_ALERTS_CLOUDFRONT_ID_PREVIEW = os.getenv("GOVUK_ALERTS_CLOUDFRONT_ID_PREVIEW")
    GOVUK_ALERTS_CLOUDFRONT_ENABLED = os.getenv("GOVUK_ALERTS_CLOUDFRONT_ENABLED", "true").lower() != "false"
    GOVUK_ALERTS_CLOUDFRONT_URL = os.getenv("GOVUK_ALERTS_CLOUDFRONT_URL")
    GOVUK_ALERTS_ORIGIN_KVS_ARN = os.getenv("GOVUK_ALERTS_ORIGIN_KVS_ARN")
    GOVUK_ALERTS_ORIGIN_KVS_KEY = os.getenv("GOVUK_ALERTS_ORIGIN_KVS_KEY", "origin")
